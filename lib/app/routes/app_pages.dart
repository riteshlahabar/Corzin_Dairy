...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: _Paths.DIET_PLAN, page: () => DietPlanView(mode: DietPlanViewMode.add)),
    GetPage(name: _Paths.DIET_PLAN_LIST, page: () => DietPlanView(mode: DietPlanViewMode.list)),
